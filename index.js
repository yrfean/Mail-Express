...
fs.createReadStream("students.csv")
  ...
  .on("data", (row) => {
    ...
    if (topicsToCover.trim().toLowerCase() === "leave") {
      msgBody = `
        <div style="font-family: Arial, sans-serif; line-height: 1.6;">
    
        <p>Dear ${name},</p>
    
        <p>We noticed your absence on the scheduled review day.</p>
    
        <p style="color:red;" >As per our evaluation policy, a fine of <strong>₹500</strong> applies for missing the review without prior notice.</p>
    
        <p>It is crucial to attend reviews, as they directly impact your learning journey and progression within the program.</p>
    
        <p>Please ensure the fine is settled at the earliest and connect with your mentor for rescheduling your evaluation if applicable.</p>
    
        <p>If you had a genuine reason for the absence, feel free to inform us, and we will review your case.</p>
